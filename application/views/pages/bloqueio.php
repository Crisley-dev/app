...
<div class="card text-center m-auto rounded" style="width: 32rem;">
  ...
  <input type="email" name="email" id="inputEmail" class="form-control" placeholder="Email" required autofocus  disabled readonly>
  <label for="inputPassword" class="sr-only">Senha</label>
  <input type="password" name="password" id="inputPasswordMatch" class="form-control" placeholder="Senhas" required  disabled readonly>
  <div class="checkbox mb-3">
  </div>
	<p>
		<a href="<?= base_url()?>signup">Criar uma conta?</a>
	</p>
  <button class="btn btn-lg btn-primary btn-block" type="submit" disabled>Entrar</button>
