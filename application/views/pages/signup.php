...
<meta name="theme-color" content="#563d7c">
  ...
  <label for="inputPassword" class="sr-only">Confirmar Senha</label>
	<input type="password" name="passwordmatch" id="inputPasswordMatch" class="form-control" placeholder="Confirmar Senha" required>
	
	<p>
		<a href="<?= base_url()?>login">Ja possui uma conta? Logue-se</a>
	</p>
